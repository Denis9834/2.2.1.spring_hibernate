...
1. Создайте соединение к своей базе данных и схему. В случае необходимости замените драйвер на подходящей для вашей СУБД. Например postgres. Запустите приложение. Проверьте, что оно полностью работает.
